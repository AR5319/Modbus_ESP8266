...
IPAddress remote(192, 168, 0, 114); // Address of Modbus Slave device
// const int32_t showDelay = 5000;      // Show result every n'th mellisecond

// Enter a MAC address and IP address for your controller below.
byte mac[] = {
    0xf4, 0xcf, 0xa2, 0x65, 0x23, 0x34};
IPAddress ip(192, 168, 0, 113); // The IP address will be dependent on your local network:
